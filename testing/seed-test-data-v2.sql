...
BEGIN
  ...
  INSERT INTO user_roles (user_id, role_id, assigned_at) VALUES
    ('u1111111-1111-1111-1111-111111111111', admin_role_id, NOW()),
    ('u1111111-1111-1111-1111-111111111112', manager_role_id, NOW()),
    ('u1111111-1111-1111-1111-111111111113', employee_role_id, NOW()),
    ('u1111111-1111-1111-1111-111111111114', client_role_id, NOW()),
    ('u1111111-1111-1111-1111-111111111115', employee_role_id, NOW())
  ...
  INSERT INTO user_roles (user_id, role_id, assigned_at) VALUES
    ('u2222222-2222-2222-2222-222222222221', admin_role_id, NOW()),
    ('u2222222-2222-2222-2222-222222222222', manager_role_id, NOW()),
    ('u2222222-2222-2222-2222-222222222223', employee_role_id, NOW()),
    ('u2222222-2222-2222-2222-222222222224', employee_role_id, NOW())
  ON CONFLICT DO NOTHING;
  ...
  INSERT INTO user_roles (user_id, role_id, assigned_at) VALUES
    ('u3333333-3333-3333-3333-333333333331', admin_role_id, NOW()),
    ('u3333333-3333-3333-3333-333333333332', manager_role_id, NOW()),
    ('u3333333-3333-3333-3333-333333333333', employee_role_id, NOW()),
    ('u3333333-3333-3333-3333-333333333334', employee_role_id, NOW())
  ON CONFLICT DO NOTHING;
  ...
  INSERT INTO user_roles (user_id, role_id, assigned_at) VALUES
    ('u4444444-4444-4444-4444-444444444441', admin_role_id, NOW()),
    ('u4444444-4444-4444-4444-444444444442', employee_role_id, NOW()),
    ('u4444444-4444-4444-4444-444444444443', employee_role_id, NOW())
  ON CONFLICT DO NOTHING;
  ...
  INSERT INTO user_roles (user_id, role_id, assigned_at) VALUES
    ('u5555555-5555-5555-5555-555555555551', admin_role_id, NOW()),
    ('u5555555-5555-5555-5555-555555555552', employee_role_id, NOW()),
    ('u5555555-5555-5555-5555-555555555553', employee_role_id, NOW())
  ON CONFLICT DO NOTHING;
END $$;
...
VALUES
  ...
  ('c1111111-1111-1111-1111-111111111111', '11111111-1111-1111-1111-111111111111', 
   ...
   '123 Business St, New York, NY 10001', 'active', 'u1111111-1111-1111-1111-111111111111', NOW(), NOW()),
  ...
  ('c1111111-1111-1111-1111-111111111112', '11111111-1111-1111-1111-111111111111', 
   ...
   '456 Tech Ave, San Francisco, CA 94102', 'active', 'u1111111-1111-1111-1111-111111111112', NOW(), NOW()),
  ...
  ('c1111111-1111-1111-1111-111111111113', '11111111-1111-1111-1111-111111111111', 
   ...
   '789 Innovation Dr, Austin, TX 78701', 'active', 'u1111111-1111-1111-1111-111111111111', NOW(), NOW()),
  ...
  ('c1111111-1111-1111-1111-111111111114', '11111111-1111-1111-1111-111111111111', 
   ...
   '321 Cloud Blvd, Seattle, WA 98101', 'prospect', 'u1111111-1111-1111-1111-111111111112', NOW(), NOW()),
  ...
  ('c1111111-1111-1111-1111-111111111115', '11111111-1111-1111-1111-111111111111', 
   ...
   '654 Commerce Way, Chicago, IL 60601', 'active', 'u1111111-1111-1111-1111-111111111111', NOW(), NOW()),
  ...
  ('c2222222-2222-2222-2222-222222222221', '22222222-2222-2222-2222-222222222222', 
   ...
   '10 Oxford Street, London W1D 1AN, UK', 'active', 'u2222222-2222-2222-2222-222222222221', NOW(), NOW()),
  ...
  ('c2222222-2222-2222-2222-222222222222', '22222222-2222-2222-2222-222222222222', 
   ...
   '25 Rue de la Paix, 75002 Paris, France', 'active', 'u2222222-2222-2222-2222-222222222221', NOW(), NOW()),
  ...
  ('c2222222-2222-2222-2222-222222222223', '22222222-2222-2222-2222-222222222222', 
   ...
   'Av. da Liberdade 123, 1250-096 Lisbon, Portugal', 'prospect', 'u2222222-2222-2222-2222-222222222222', NOW(), NOW()),
  ...
  ('c3333333-3333-3333-3333-333333333331', '33333333-3333-3333-3333-333333333333', 
   ...
   '1000 Wilshire Blvd, Los Angeles, CA 90017', 'active', 'u3333333-3333-3333-3333-333333333331', NOW(), NOW()),
  ...
  ('c3333333-3333-3333-3333-333333333332', '33333333-3333-3333-3333-333333333333', 
   ...
   '200 N Spring St, Los Angeles, CA 90012', 'active', 'u3333333-3333-3333-3333-333333333331', NOW(), NOW()),
  ...
  ('c3333333-3333-3333-3333-333333333333', '33333333-3333-3333-3333-333333333333', 
   ...
   '1234 Harbor Dr, San Diego, CA 92101', 'prospect', 'u3333333-3333-3333-3333-333333333332', NOW(), NOW()),
  ...
  ('c4444444-4444-4444-4444-444444444441', '44444444-4444-4444-4444-444444444444', 
   ...
   '800 Michigan Ave, Chicago, IL 60611', 'active', 'u4444444-4444-4444-4444-444444444441', NOW(), NOW()),
  ...
  ('c4444444-4444-4444-4444-444444444442', '44444444-4444-4444-4444-444444444444', 
   ...
   '1500 S Michigan Ave, Chicago, IL 60605', 'active', 'u4444444-4444-4444-4444-444444444441', NOW(), NOW()),
  ...
  ('c5555555-5555-5555-5555-555555555551', '55555555-5555-5555-5555-555555555555', 
   ...
   'Hauptstraße 100, 10827 Berlin, Germany', 'active', 'u5555555-5555-5555-5555-555555555551', NOW(), NOW()),
  ...
  ('c5555555-5555-5555-5555-555555555552', '55555555-5555-5555-5555-555555555555', 
   ...
   'Industrieweg 50, 10115 Berlin, Germany', 'active', 'u5555555-5555-5555-5555-555555555551', NOW(), NOW()),
  ...
  ('c5555555-5555-5555-5555-555555555553', '55555555-5555-5555-5555-555555555555', 
   ...
   'Leopoldstraße 25, 80802 Munich, Germany', 'prospect', 'u5555555-5555-5555-5555-555555555552', NOW(), NOW())
ON CONFLICT (id) DO NOTHING;
